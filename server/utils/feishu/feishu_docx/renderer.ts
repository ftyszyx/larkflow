import { Block, DocMetaInfo, CommonBlock } from './types.ts';
...
export class Renderer {
  ...
  constructor(
    doc: any, options: { debug?: boolean; outputUnsupported?: boolean } = {}) {
 ...
 *
 * This for avoid Feishu paragraph text has `<` or `>` charactor, will break the
 * HTML structure. In some Static Site Generator (VitePress, Docusaurus), the
 * used JSX and Vue template, will cause the HTML structure broken.
 *
 * - `>` -> `&gt;` (Danger, > in Markdown is used for blockquote)
 * - `<` -> `&lt;`
 *
 * This method must make sure used to escape the Plain Text, not the Markdown
 * Text.
 *
 * @param plainText
